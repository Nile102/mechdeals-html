    ...
    <footer class="footer-container typefooter-1">
        ...
        <div class="container">
            <div class="row footer-middle">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 col-style">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12 col-style">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 col-clear">
                            <div class="box-service box-footer">
                              <div class="module clearfix">
                                <h3 class="modtitle">Download App</h3>
                                <div class="modcontent">
                                  <ul class="list-unstyled appLogo">
                                    <li><a href="#"><img src="image/play-store.png" class="img-responsive"></a></li>
                                    <li></li>
                                    <li><a href="#"><img src="image/app-store.png" class="img-responsive"></a></a></li>
                                  </ul>
                                </div>
                              </div>
                            </div>
            ...
            <div class="footerdesc">
                <p class="text-center">All manufacturer names symbols and descriptions used in our images and text are used solely for indentification purposes only.It is neither inferred nor implied that any item sold by MechDeals.com is a product authorized by or in any way connected with any vehicle manufacturers displayedon this page</p>
            </div>
        </div>
        <!-- /Footer middle Container -->
        ...
        <div class="footer-bottom">        
            <div class="container">
                <p class="text-center">© 2020 Wemech Innovation Private Limited</p>
            </div>            
        </div>
        <!-- /Footer Bottom Container -->
